...
[![Extract Plezy APKs](https://github.com/ExperimentalSubject-8C/plezy-apks/actions/workflows/extract.yaml/badge.svg)](https://github.com/ExperimentalSubject-8C/plezy-apks/actions/workflows/extract.yaml)
...
3. Paste this URL:
   ```
   https://github.com/ExperimentalSubject-8C/plezy-apks
   ```
...
Head to the [Releases](https://github.com/ExperimentalSubject-8C/plezy-apks/releases/latest) page and grab the APK for your architecture.
